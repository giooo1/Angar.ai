    ...
    <header className="sticky top-4 z-20 flex items-center justify-between gap-3 px-3.5 py-2.5 rounded-xl border border-line bg-paper/95 backdrop-blur-sm shadow-[0_8px_24px_-18px_rgba(20,15,5,0.25)]">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          disabled={busy}
          title="Re-extract"
          className="hidden sm:inline-flex text-[12.5px] text-ink-3 hover:text-ink-2 hover:underline font-[450] cursor-pointer items-center gap-1 disabled:opacity-60 disabled:no-underline"
        >
          <span
            aria-hidden="true"
            className={cn("inline-block", busy && "animate-[spin_0.8s_linear_infinite]")}
          >
            ↻
          </span>
